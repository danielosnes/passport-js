...
PostgreSQL internal permissions tables — You learned about the tables you can reference to monitor the privileges of the users in your database. 
With this knowledge, you’ll be able to safely delegate the correct permissions to other users in the database.
...
Hopefully, this has been helpful in introducing some of the core concepts of PostgreSQL security.
*/